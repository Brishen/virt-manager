...
RUN yum install -y libvirt-python gtk3-devel zlib gtksourceview3-devel tree libxslt-devel libffi-devel gobject-introspection-devel openssl openssl-devel cairo-devel cairo-gobject-devel pycairo-devel
